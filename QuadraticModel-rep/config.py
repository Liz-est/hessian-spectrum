...
from opt import CompletePAdam, CompletePMuon
...
class RunConfig:
    ...
    # 数据
    data_dir: str = "/data/250010020/hessian-spectrum/data/fineweb_edu_100B_parquet/sample/100BT"
    out_dir: str = "/data/250010020/hessian-spectrum/QuadraticModel-rep/checkpoints_b64"
...
_MUON = replace(
    ...
    out_dir="/data/250010020/hessian-spectrum/QuadraticModel-rep/checkpoints_b64_muon",
)
...
_SMOKE_ADAM = RunConfig(
    ...
    optim=OptimConfig(name="adam"),
    out_dir="/data/250010020/hessian-spectrum/QuadraticModel-rep/test_outputs/smoke_adam",
...
_SMOKE_MUON = replace(copy.deepcopy(_SMOKE_ADAM), name="smoke_muon",
                      optim=OptimConfig(name="muon"),
                      out_dir="/data/250010020/hessian-spectrum/QuadraticModel-rep/test_outputs/smoke_muon")
...
def _muon_lr_preset(lr):
    ...
    return replace(
        ...
        name=tag,
        opt_lr=float(lr),
        out_dir=f"/data/250010020/hessian-spectrum/QuadraticModel-rep/test_outputs/{tag}",
