...
from src.analysis.rebuild_bands import lanczos_from_measure
from src.spectrum.gauss_radau import compute_spectrum_with_error_bands

SRC = str(paths.OUT_DIR / "spectrum_ddp_p100_m1200.npz")
DST = str(paths.OUT_DIR / "spectrum_ddp_p100_m1200_reband.npz")
