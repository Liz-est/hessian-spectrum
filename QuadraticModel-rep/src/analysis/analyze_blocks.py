...
from src.model.blocks import UnitHessian                                  # noqa: E402
from src.analysis.hetero import common_log_edges, spectra_to_prob, pairwise_matrix, hetero_mean  # noqa: E402
...
def main():
    ...
    ap.add_argument("--token_freq", default=str(paths.OUT_DIR / "token_freq_v8192.npz"),
