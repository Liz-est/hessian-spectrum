...
out=$($SCO acp jobs create \
  ...
  --command "bash /data/250010020/hessian-spectrum/QuadraticModel-rep/run_spectrum_ddp_inner.sh p100 2>&1 | tee /data/250010020/hessian-spectrum/QuadraticModel-rep/test_outputs/spectrum_ddp_p100_m1200.log" \
  2>&1)
