...
out=$($SCO acp jobs create \
  ...
  --command "bash /data/250010020/hessian-spectrum/QuadraticModel-rep/run_spectrum_frob2_inner.sh 2>&1 | tee /data/250010020/hessian-spectrum/QuadraticModel-rep/test_outputs/frob2_ab_p100.log" \
  2>&1)
