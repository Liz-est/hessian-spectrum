...
/root/.sco/bin/sco --profile zhanglixian-g acp jobs create \
  ...
  --worker-nodes 1 \
  --command "cd /data/250010020/hessian-spectrum/QuadraticModel-rep && /data/250010020/miniconda3/envs/nanogpt/bin/torchrun --standalone --nproc_per_node=8 train.py > test_outputs/train_b64.log 2>&1"
