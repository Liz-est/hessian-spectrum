...
from layers import build_layers, full_block, check_partition
from hvp_layers import SharedBatchOp
from lanczos_layers import block_seed
...
def main():
    ...
    for kind, brute_fn in (("hessian", brute_hessian), ("gn", brute_gn)):
        ...
        if kind == "gn":
            ...
            from model import rmsnorm as _rn
            with torch.no_grad():
                h = model.embd[x]
