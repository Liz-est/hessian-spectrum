...
class GPTConfig:
    ...
    device: str= 'cuda'
    tie_weights: bool = True # tie wte and lm_head. Set False to study the last layer's Hessian independently.
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        # Disable via config.tie_weights=False so lm_head is an independent tensor,
        # letting us attribute the "last layer" Hessian cleanly (not entangled with wte).
        if config.tie_weights:
            self.transformer.wte.weight = self.lm_head.weight # https://paperswithcode.com/method/weight-tying
        else:
            print('[model] weight tying DISABLED: wte and lm_head are independent parameters')
